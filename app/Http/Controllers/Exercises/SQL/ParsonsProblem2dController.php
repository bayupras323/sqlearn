...
use App\Http\Requests\StoreParsonsProblem2DRequest;
...
class ParsonsProblem2dController extends Controller
{
    /**
     * Store a newly created resource in storage.
     *
     */
    public function store(StoreParsonsProblem2DRequest $request): RedirectResponse
    {  
        $validated = $request->validated();
        $validated['answer'] = str_replace(PHP_EOL, "\n", $validated['answer']);
        $validated['answer'] = str_replace("\r\n", "\n", $validated['answer']);
        $validated['answer'] = str_replace("\n", "\\n", $validated['answer']);
    ...
    public function show(Package $package, Exercise $exercise): Factory|View|Application
    {
        ...
        $answer = $databaseController->convertData($exercise->answer['queries']);
