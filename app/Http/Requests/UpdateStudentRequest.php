...
class UpdateStudentRequest extends FormRequest
{
    ...
    {
        return [
            'student_id_number' => ['required', 'numeric', 'unique:students,student_id_number, ' . $this->student->id, 'digits:10'],
    ...
    public function messages()
    {
        return [
            ...
            'name.regex' => 'Attribute Nama tidak boleh berisi karakter dan angka',
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            if ($validator->errors()->isNotEmpty()) {
                ...
                $validator->errors()->add('student-id', $this->student->id);
            }
        });
    }
}
