    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Daftar Nilai</div>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h4>Daftar Nilai dari Jadwal</h4>
                                ...
                                <form id="search" method="GET" action="{{ route('scores.index') }}">
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" id="name" name="schedule-keyword" data-id="cari_latihan_select" class="form-control" value="{{ old('schedule-keyword') }}">
                                        </div>
                                        <div class="form-group col-md-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    <tr>
                                        ...
                                        <th style="width: 16% !important;">Mengerjakan</th>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 14% !important;" class="badges">
                                                @foreach($schedule->classrooms as $classroom)
                                                    <span class="badge badge-light">{{ $classroom->name }}</span>
                                                    @php
                                                        // count all student in any classroom
                                                        $all_students += $classroom->students->count();
                                                    @endphp
                                                @endforeach
                                            </td>
                                            ...
                                            <td style="width: 16% !important;">
                                                @php
                                                $percentage = round($schedule->scores->count() / $all_students * 100, 2);
                                                @endphp
                                                <div class="progress mb-1" data-height="8"
                                                     data-toggle="tooltip" title="{{ $percentage }}">
                                                ...
                                                {{ $schedule->scores->count() }}/{{ $all_students }} Mahasiswa ({{ $percentage }}%)
                                            </td>
                                            <td style="width: 12% !important;">
                                                <a href="{{ route('scores.show', $schedule->id) }}" class="btn btn-link">
                                                    <i class="fas fa-list-ol"></i> Lihat Nilai
                                                </a>
                                            </td>
                                        </tr>
                                    @empty
