                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="create-exercise-form" data-id="create-exercise-form" class="wizard-content mt-2"
                                ...
                                <input type="hidden" name="ddl_type" id="ddl_type" value="alter rename column">
                                <div id="stepper" class="bs-stepper">
                                    <!-- Header -->
                                    @include('packages.exercises.categories.DDL.rename-column.wizards.header')
                                    <!-- Content -->
                                    @include('packages.exercises.categories.DDL.rename-column.wizards.content')
                                </div>
                            </form>
                        </div>
                    </div>
...
@push('customScript')
    ...
    <script src="{{ asset('assets/js/page/create-exercise-ddl-rename-column.js') }}"></script>
@endpush
