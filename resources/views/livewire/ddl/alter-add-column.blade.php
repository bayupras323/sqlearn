                                            ...
                                            <div class="collapse {{$show[$i] ?? ''}}" id="collapseExample-{{$i}}">
                                                <div>
                                                    <form wire:submit.prevent="addAnswer({{$i}})">
                                                        ...
                                                        <div class="mt-2">
                                                            <select name="columnKey" class="form-control" data-id="columnKey.{{ $i }}" wire:model="colKey.{{ $i }}" :key="colKey.{{ $i }}">
                                                        ...
                                                        <div class="mt-2">
                                                            <select name="columnNullability" class="form-control" data-id="columnNullability.{{ $i }}" wire:model="colNullability" :key="colNullability.{{ $i }}">
                                                        ...
                                                        <div class="mt-2">
                                                            <select name="columnDefault" class="form-control" data-id="columnDefault.{{ $i }}" wire:model="colDefault" :key="colDefault.{{ $i }}">
                                                        ...
                                                        <div class="mt-2">
                                                            <select name="columnExtra" class="form-control" data-id="columnExtra.{{ $i }}" wire:model="colExtra" :key="colExtra.{{ $i }}">
