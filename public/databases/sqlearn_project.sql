...
ALTER TABLE `project_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pj_pj` (`project_id`),
  ADD KEY `pj_cl` (`client_id`);
...
--
ALTER TABLE `project_clients`
  ADD CONSTRAINT `pj_cl` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`),
  ADD CONSTRAINT `pj_pj` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`);
COMMIT;
